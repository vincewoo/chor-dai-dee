...
const VoiceControlBubble = ({
  ...
  // Use audio level from context if available, otherwise fall back to prop
  const contextAudioLevel = username ? audioLevels?.[username] : undefined;
  const audioLevel = contextAudioLevel !== undefined ? contextAudioLevel : (propAudioLevel || 0);
