...
/**
 * Player Voice Indicator - consumes VoiceAudioContext directly to isolate re-renders
 */
const PlayerVoiceIndicator = ({ playerName }) => {
    const { audioLevels } = useVoiceAudio();
    const isActive = audioLevels && audioLevels[playerName] > 0.05;
...
const PlayerAvatar = memo(PlayerAvatarBase);
