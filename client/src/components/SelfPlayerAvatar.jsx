 ...
 * SelfPlayerAvatar
 *
 * Displays the current user's avatar, voice indicator, and stats.
 * Consumes VoiceAudioContext directly to prevent GameRoom re-renders.
 */
const SelfPlayerAvatar = ({ user, isMyTurn, playerRating, cardCount }) => {
