...
import ConnectedVoiceControlBubble from './ConnectedVoiceControlBubble';
import { useVoiceControl } from '../contexts/VoiceContext';
...
const GameRoom = ({ user, socket }) => {
    ...
    // ⚡ Bolt Optimization: Use useVoiceControl instead of useVoice to avoid re-renders on audio level changes
    const voiceContext = useVoiceControl();
