...
export const VoiceAudioContext = createContext(null);
...
export const VoiceProvider = ({ socket, children }) => {
  ...
  // Construct audio state (high frequency updates)
  ...
  return (
    <VoiceContext.Provider value={voiceState}>
      <VoiceAudioContext.Provider value={audioState}>
        {children}
