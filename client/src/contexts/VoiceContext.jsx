...
export const VoiceProvider = ({ socket, children }) => {
  ...
  // ⚡ Bolt Optimization: Split context into stable logic and high-frequency audio levels
  const value = useMemo(() => ({
    // State
    voiceEnabled,
    isVoiceConnected,
    ...
    // audioLevels REMOVED - moved to VoiceAudioContext
    permissionError,
    playerVolumes,
    ...
    isDeafened,
    currentRoomId,
    peers, // Object.keys depends on the peers object
    permissionError,
    playerVolumes,
    joinVoiceRoom,
    leaveVoiceRoom,
